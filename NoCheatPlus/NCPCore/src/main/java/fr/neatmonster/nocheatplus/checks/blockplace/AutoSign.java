...
public class AutoSign extends Check {
    ...
    public boolean check(final ServerPlayer player, final Block block, final String[] lines,
     ...
     * @return
     */
    private boolean handleViolation(final ServerPlayer player, final long violationTime,
