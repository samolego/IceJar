...
public class DebugUtil {
    ...
    public static void addLocation(final ServerPlayerLocation loc, final StringBuilder builder){
        builder.append(LocUtil.simpleFormat(loc));
    }
     ...
     * @param builder
     */
    public static void addMove(final ServerPlayerLocation from, final ServerPlayerLocation to, final Location loc, final StringBuilder builder){
     ...
     * @param builder
     */
    public static void addMove(final ServerPlayerLocation from, final ServerPlayerLocation to, final StringBuilder builder) {
        builder.append("From: ");
    ...
    public static void addBlockBelowInfo(final StringBuilder builder, final ServerPlayerLocation loc, final String tag) {
        addBlockInfo(builder, loc.getBlockCache(), loc.getBlockX(), loc.getBlockY() - 1, loc.getBlockZ(), tag + " below");
    }

    public static void addBlockInfo(final StringBuilder builder, final ServerPlayerLocation loc, final String tag) {
