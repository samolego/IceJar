...
public class NCPExemptionManager {
     ...
     *            the player
     */
    public static final void exemptPermanently(final ServerPlayer player) {
     ...
     *            The check type.
     */
    public static final void exemptPermanently(final ServerPlayer player, final CheckType checkType) {
     ...
     */
    public static final boolean isExempted(final ServerPlayer player, final CheckType checkType) {
     ...
     *            the player
     */
    public static final void unexempt(final ServerPlayer player) {
     ...
     *            the check type
     */
    public static final void unexempt(final ServerPlayer player, final CheckType checkType) {
