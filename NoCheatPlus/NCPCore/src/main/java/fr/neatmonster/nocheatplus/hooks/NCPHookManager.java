...
public final class NCPHookManager {
     ...
     */
    private static final boolean applyHooks(final CheckType checkType, final ServerPlayer player, final IViolationInfo info, final List<NCPHook> hooks) {
     ...
     *            the throwable
     */
    private static final void logHookFailure(final CheckType checkType, final ServerPlayer player, final NCPHook hook, final Throwable t) {
