...
public class PlayerSetBackMethod {
     ...
     */
    public static final ServerPlayerSetBackMethod LEGACY = new PlayerSetBackMethod("default.legacy", 
     ...
     */
    public static final ServerPlayerSetBackMethod CAUTIOUS = new PlayerSetBackMethod("default.cautious", 
            CANCEL | UPDATE_FROM | SCHEDULE | NO_RISK);
    /**
     * Meant for the latest thing.
     */
    public static final ServerPlayerSetBackMethod MODERN = new PlayerSetBackMethod("default.modern", 
            CANCEL | UPDATE_FROM | SCHEDULE);

    public static final ServerPlayerSetBackMethod fromString(String name, String input) {
