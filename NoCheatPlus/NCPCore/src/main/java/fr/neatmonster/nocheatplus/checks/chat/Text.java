...
public class Text extends Check implements INotifyReload {
     ...
     * @return
     */
    public boolean check(final ServerPlayer player, final String message,
     ...
     * @return
     */
    private boolean unsafeCheck(final ServerPlayer player, final String message, final ICaptcha captcha,
