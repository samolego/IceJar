...
public class CollisionUtil {
     ...
     * @return the double
     */
    public static double directionCheck(final ServerPlayer player, final double targetX, final double targetY, final double targetZ, final double targetWidth, final double targetHeight, final double precision)
    {
	...
	public static boolean isCollidingWithEntities(final ServerPlayer p, final boolean onlylivingenitites) {
