...
public class PacketFrequency extends Check {
     ...
     */
    public boolean check(final ServerPlayer player, final NetData data, final NetConfig cc) {
     ...
     * @return
     */
    public void relax(final ServerPlayer player, final NetData data, final NetConfig cc) {
