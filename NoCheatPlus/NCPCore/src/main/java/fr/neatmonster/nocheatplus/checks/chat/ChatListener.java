...
public class ChatListener extends CheckListener implements INotifyReload, JoinLeaveListener {
    ...
    public void onPlayerCommandPreprocess(final ServerPlayerCommandPreprocessEvent event) {
        final ServerPlayer player = event.getPlayer();
    ...
    private boolean checkUntrackedLocation(final ServerPlayer player, final String message,
    ...
    private boolean textChecks(final ServerPlayer player, final String message,
