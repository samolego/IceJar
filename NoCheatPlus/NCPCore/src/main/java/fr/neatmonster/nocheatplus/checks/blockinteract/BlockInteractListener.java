...
public class BlockInteractListener extends CheckListener {
    ...
    public static void debugBlockVSBlockInteract(final ServerPlayer player, final CheckType checkType, 
    ...
    private void logUsedFlyingPacket(final ServerPlayer player, final FlyingQueueHandle flyingHandle, 
    ...
    private void onCancelInteract(final ServerPlayer player, final Block block, final BlockFace face, 
            final ServerPlayerInteractEvent event, final int previousLastTick, final boolean preventUseItem, 
    ...
    public void onPlayerInteractMonitor(final ServerPlayerInteractEvent event) {
    ...
    private void checkEnderPearlRightClickBlock(final ServerPlayer player, final Block block, 
            final BlockFace face, final ServerPlayerInteractEvent event, 
    ...
    private void genericDebug(final ServerPlayer player, final Block block, final BlockFace face, 
            final ServerPlayerInteractEvent event, final String tag, final int previousLastTick, 
