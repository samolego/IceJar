...
public class FastBreak extends Check {
     ...
     */
    public boolean check(final ServerPlayer player, final Block block, final AlmostBoolean isInstaBreak,
    ...
    private void tailDebugStats(final ServerPlayer player, final AlmostBoolean isInstaBreak,
