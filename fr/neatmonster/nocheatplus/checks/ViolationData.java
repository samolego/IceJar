...
public class ViolationData implements IViolationInfo, ActionData {
     ...
     *            the actions
     */
    public ViolationData(final Check check, final ServerPlayer player,
    ...
    private String getImplicitValue(final ParameterName parameterName) {
        switch (parameterName) {
            ...
            case IP:
                return player.getIpAddress().substring(1).split(":")[0];
            case PLAYER:
            case PLAYER_NAME:
            ...
            case WORLD: {
                ...
                return world == null ? player.getLevel().dimension().toString() : world;
            }
            default:
                return null;
        }
