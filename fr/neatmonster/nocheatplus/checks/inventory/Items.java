...
public class Items extends Check{
     ...
     */
    public static final boolean checkIllegalEnchantmentsAllHands(final ServerPlayer player,
     ...
     * @return True if the check is failed.
     */
    public static final boolean checkIllegalEnchantments(final ServerPlayer player,
