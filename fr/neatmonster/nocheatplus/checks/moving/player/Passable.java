...
public class Passable extends Check {
    ...
    public Location check(final ServerPlayer player,
    ...
    private Location checkActual(final ServerPlayer player,
            final ServerPlayerLocation from, final ServerPlayerLocation to,
            final MovingData data, final MovingConfig cc, final IPlayerData pData,
            final int tick, final boolean useBlockChangeTracker) {
    ...
    private String checkRayTracingAlernateOrder(final ServerPlayer player,
            final ServerPlayerLocation from, final ServerPlayerLocation to,
    ...
    private String checkRayTracing(final ServerPlayer player,
            final ServerPlayerLocation from, final ServerPlayerLocation to, final int manhattan,
     ...
     * @param from
     */
    private void setNormalMargins(final ICollidePassable rayTracing, final ServerPlayerLocation from, final MovingConfig cc) {
     ...
     * @return
     */
    private Location potentialViolation(final ServerPlayer player,
            final ServerPlayerLocation from, final ServerPlayerLocation to,
            final int manhattan, final boolean debug,
    ...
    private Location actualViolation(final ServerPlayer player,
            final ServerPlayerLocation from, final ServerPlayerLocation to,
