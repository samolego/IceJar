...
public class InLiquidRules {
     ...
     */
    public static Double liquidWorkarounds(final ServerPlayerLocation from, final ServerPlayerLocation to, final double baseSpeed, final double frictDist, final ServerPlayerMoveData lastMove, final MovingData data) {
