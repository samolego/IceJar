...
public class ViolationHistory {
     ...
     * @return the history
     */
    public static ViolationHistory getHistory(final ServerPlayer player) {
        return getHistory(player.getGameProfile().getName(), true);
    }
     ...
     */
    public static ViolationHistory getHistory(final ServerPlayer player, final boolean create) {
        return getHistory(player.getGameProfile().getName(), create);
    }
