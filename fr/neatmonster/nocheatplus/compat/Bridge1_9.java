...
public class Bridge1_9 {
     ...
     */
    public static double getLevitationAmplifier(final ServerPlayer player) {
        if (LEVITATION == null) {
     ...
     * @return
     */
    public static boolean isGlidingWithElytra(final ServerPlayer player) {
     ...
     * @return
     */
    public static boolean isWearingElytra(final ServerPlayer player) {
        if (ELYTRA == null) {
            return false;
        }
        else {
     ...
     * @return
     */
    public static boolean hasItemInAnyHand(final ServerPlayer player, final Material material) {
     ...
     * @param item
     */
    public static void setItemInMainHand(final ServerPlayer player, final ItemStack item) {
     ...
     */
    public static ItemStack getItemInOffHand(final ServerPlayer player) {
     ...
     * @param event
     */
    public static ItemStack getUsedItem(final ServerPlayer player, final ServerPlayerInteractEvent event) {
     ...
     * @param event
     */
    public static ItemStack getUsedItem(final ServerPlayer player, final ServerPlayerInteractEntityEvent event) {
        if (!hasGetItemInOffHand()) { // Optimistic check.
            return getItemInMainHand(player);
        }
        else {
