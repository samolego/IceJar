...
public class BlockChangeListener implements Listener {
    ...
    private void onPlayerInteract(final ServerPlayerInteractEvent event) {
        // Check preconditions.
    ...
    private void onInteractPhysical(final ServerPlayerInteractEvent event) {
    ...
    private void onRightClickBlock(final ServerPlayerInteractEvent event) {
