 ...
 * @param <V>
 */
public class CoordHashMap<V> extends AbstractCoordHashMap<V, AbstractCoordHashMap.HashEntry<V>> implements CoordMap<V> {
    ...
    @Override
    protected HashEntry<V> newEntry(int x, int y, int z, V value, int hash) {
