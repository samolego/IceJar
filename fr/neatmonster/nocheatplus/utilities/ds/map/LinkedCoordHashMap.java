 ...
 * @param <V>
 */
public class LinkedCoordHashMap<V> extends AbstractCoordHashMap<V, LinkedCoordHashMap.LinkedHashEntry<V>> implements CoordMap<V> {
    ...
    public static class LinkedHashEntry<V> extends HashEntry<V> {
