...
public class DataManager {
     ...
     * @return
     */
    public static ServerPlayer getPlayer(final UUID id) {
     ...
     * @return
     */
    public static ServerPlayer getPlayer(final String playerName) {
     ...
     * @return
     */
    public static IPlayerData getPlayerData(final ServerPlayer player) {
     ...
     * @return
     */
    public static <T> T getGenericInstance(final ServerPlayer player, final Class<T> registeredFor) {
     ...
     */
    public static IPlayerData getPlayerDataSafe(final ServerPlayer player) {
        try {
