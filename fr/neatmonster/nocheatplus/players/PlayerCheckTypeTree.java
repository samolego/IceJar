...
public class PlayerCheckTypeTree extends CheckTypeTree<PlayerCheckTypeTreeNode>{
    ...
    static class PlayerCheckTypeTreeNode extends CheckNodeWithDebug<PlayerCheckTypeTreeNode> implements IBaseCheckNode {
        ...
        PlayerCheckTypeTreeNode(final CheckType checkType,
                final ServerPlayerCheckTypeTreeNode parent,
        ...
        private void setDebugNoUpdate(final IWorldData worldData) {
            ...
            for (final ServerPlayerCheckTypeTreeNode node : getChildren()) {
    ...
    public void exempt(final CheckType checkType, final ExemptionContext context) {
        final ServerPlayerCheckTypeTreeNode node = getNode(checkType);
        if (node == null) {
    ...
    private void exemptPrimaryThread(final ServerPlayerCheckTypeTreeNode node, final ExemptionContext context) {
        visitWithDescendants(node, new Visitor<PlayerCheckTypeTreeNode>() {
            @Override
            public boolean visit(final ServerPlayerCheckTypeTreeNode node) {
    ...
    private void exemptAsynchronous(final ServerPlayerCheckTypeTreeNode node, final ExemptionContext context) {
        lock.lock();
        visitWithDescendants(node, new Visitor<PlayerCheckTypeTreeNode>() {
            @Override
            public boolean visit(final ServerPlayerCheckTypeTreeNode node) {
    ...
    private void unexemptPrimaryThread(final ServerPlayerCheckTypeTreeNode node, final ExemptionContext context) {
        visitWithDescendants(node, new Visitor<PlayerCheckTypeTreeNode>() {
            @Override
            public boolean visit(final ServerPlayerCheckTypeTreeNode node) {
    ...
    private void unexemptAsynchronous(final ServerPlayerCheckTypeTreeNode node, final ExemptionContext context) {
        lock.lock();
        visitWithDescendants(node, new Visitor<PlayerCheckTypeTreeNode>() {
            @Override
            public boolean visit(final ServerPlayerCheckTypeTreeNode node) {
    ...
    private void unexemptAllPrimaryThread(final ServerPlayerCheckTypeTreeNode node, final ExemptionContext context) {
        visitWithDescendants(node, new Visitor<PlayerCheckTypeTreeNode>() {
            @Override
            public boolean visit(final ServerPlayerCheckTypeTreeNode node) {
    ...
    private void unexemptAllAsynchronous(final ServerPlayerCheckTypeTreeNode node, final ExemptionContext context) {
        lock.lock();
        visitWithDescendants(node, new Visitor<PlayerCheckTypeTreeNode>() {
            @Override
            public boolean visit(final ServerPlayerCheckTypeTreeNode node) {
    ...
    private boolean isExemptedPrimaryThread(final ServerPlayerCheckTypeTreeNode node, final ExemptionContext context) {
        return node.isExemptedPrimaryThread(context);
    }

    private boolean isExemptedAsynchronous(final ServerPlayerCheckTypeTreeNode node, final ExemptionContext context) {
        final boolean res;
        lock.lock();
