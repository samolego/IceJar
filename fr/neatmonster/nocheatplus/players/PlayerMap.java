...
public final class PlayerMap {
    ...
    public Player getPlayer(final UUID id) {
        final ServerPlayerInfo info = idInfoMap.get(id);
        if (info != null) {
            if (info.player != null) {
                return info.player;
            }
    ...
    public Player getPlayerExact(final String exactName) {
        final ServerPlayerInfo info = exactNameInfoMap.get(exactName);
        if (info != null) {
            if (info.player != null) {
                return info.player;
            }
    ...
    public Player getPlayerLowerCase(final String lowerCaseName) {
        final ServerPlayerInfo info = lowerCaseNameInfoMap.get(lowerCaseName);
        if (info != null) {
            if (info.player != null) {
                return info.player;
            }
    ...
    public PlayerInfo updatePlayer(final ServerPlayer player) {
    ...
    public boolean remove(final ServerPlayer player) {
    ...
    @SuppressWarnings("deprecation")
    private Player getPlayerBukkit(final ServerPlayerInfo info) {
        if (hasGetPlayer_UUID) {
     ...
     * @return
     */
    private boolean ensureRemoved(final ServerPlayerInfo info) {
     ...
     * @return
     */
    private boolean remove(final ServerPlayerInfo info) {
