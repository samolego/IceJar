...
public class NoDeceleration extends CancellableMovementCheck {
    ...
    public MutableComponent getAdditionalFlagInfo() {
        return Component.translatable("Deceleration while rotating: ")
                .append(Component.translatable(String.format("x * 10^-%d", (int) Math.log10(1/(this.diff)))).withStyle(ChatFormatting.RED));
    }
}
